...
def endless_mode():
    ...
    while in_progress:
        ...
        # Getting random question
        current_question = random.choice(questions)
        current_question_ = Question.display_question(current_question, bright_red, current_round)
    ...
    endless_mode_scoring_page(score)


def endless_mode_scoring_page(score):
